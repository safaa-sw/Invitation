                    ...
                    <div class="card-body">
                        <div>
                            <a href="{{ route('inviteds.create') }}" class="btn btn-success text-white me-0"><i
                                ...
                                إضافة</a>
                            <a href="{{route('exportInvited')}}" class="btn btn-primary text-white me-0"><i
                        ...
                        <div>
                            <form action="{{ route('inviteds/search') }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <div class="col-md-8">
                                        <label for="searchByName" class="col-md-2 col-form-label text-md-right">
                                            <h5>الاسم </h5>
                                        </label>
                                        <input type="text" id="searchByName" name="searchByName" value="">
                                        <label for="searchByEmail" class="col-md-2 col-form-label text-md-right">
